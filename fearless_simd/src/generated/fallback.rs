...
impl Simd for Fallback {
    ...
    fn cvt_u32_f32x4(self, a: f32x4<Self>) -> u32x4<Self> {
        [a[0usize] as u32, a[1usize] as u32, a[2usize] as u32, a[3usize] as u32]
            .simd_into(self)
    }
    #[inline(always)]
    ...
    fn select_i8x16(
        ...
        [
            ...
            if a[10usize] != 0 { b[10usize] } else { c[10usize] },
            if a[11usize] != 0 { b[11usize] } else { c[11usize] },
            if a[12usize] != 0 { b[12usize] } else { c[12usize] },
