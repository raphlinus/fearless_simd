...
use crate::{
    ...
    i8x32, u8x32, mask8x32, i16x16, u16x16, mask16x16, i32x8, u32x8, mask32x8, f32x16,
    i8x64, u8x64, mask8x64, i16x32, u16x32, mask16x32, i32x16, u32x16, mask32x16,
};
...
impl Simd for Neon {
    ...
    fn select_f32x4(
        ...
        unsafe {
            vbslq_f32(vreinterpretq_u32_s32(a.into()), b.into(), c.into())
                .simd_into(self)
        }
    }
    #[inline(always)]
    ...
    fn select_u8x16(
        ...
        unsafe {
            vbslq_u8(vreinterpretq_u8_s8(a.into()), b.into(), c.into()).simd_into(self)
        }
    }
    #[inline(always)]
    ...
    fn select_u16x8(
        ...
        unsafe {
            vbslq_u16(vreinterpretq_u16_s16(a.into()), b.into(), c.into())
                .simd_into(self)
        }
    }
    #[inline(always)]
    ...
    fn select_u32x4(
        ...
        unsafe {
            vbslq_u32(vreinterpretq_u32_s32(a.into()), b.into(), c.into())
                .simd_into(self)
        }
    }
    #[inline(always)]
    ...
    fn simd_eq_mask8x64(self, a: mask8x64<Self>, b: mask8x64<Self>) -> mask8x64<Self> {
        ...
        let (b0, b1) = self.split_mask8x64(b);
        self.combine_mask8x32(
            self.simd_eq_mask8x32(a0, b0),
            self.simd_eq_mask8x32(a1, b1),
        )
    }
    #[inline(always)]
    ...
    fn simd_eq_mask32x16(
        ...
        let (b0, b1) = self.split_mask32x16(b);
        self.combine_mask32x8(
            self.simd_eq_mask32x8(a0, b0),
            self.simd_eq_mask32x8(a1, b1),
        )
    }
    #[inline(always)]
